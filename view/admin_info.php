					...
					<div class="col-md-12 col-xl-12">
                        <div class="card">
							...
							<a href="?a=home" class="btn btn-success">Go back to admin home</a>
                                <h4 class="header-title mb-0">User <strong><?php echo $info['username']; ?></strong></h4>
								

                                <div id="cardCollpase5" class="collapse pt-3 show">
                                    <div class="table-responsive">
<table class="table table-hover table-centered mb-0" id="txlist">
<thead>
   <tr>
      <td nowrap>Key</td>
      <td nowrap>Value</td>
...
<form action="<?php echo '?a=info&i=' . $info['id']; ?>" method="POST" autocomplete="off" class="clearfix" id="pwdform">
    ...
    <div class="col-md-4"><button type="submit" class="btn btn-info">Change password</button></div>
</form>
<p id="pwdmsg"></p>
<br />
<p>Withdraw funds:</p>
<form action="<?php echo '?a=info&i=' . $info['id']; ?>" method="POST" autocomplete="off" class="clearfix" id="withdrawform">
    ...
    <div class="col-md-4"><button type="submit" class="btn btn-info">Withdraw</button></div>
</form>
<p id="withdrawmsg"></p>
<br />
<p>Addresses:</p>
...
<?php
   ...
   <div class="col-md-12 col-xl-12">
                        <div class="card">
                            <div class="card-body">
							<a href="?a=home" class="btn btn-info">Go back to admin home</a>
