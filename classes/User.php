...

	{
...

		{
...

			{
				...
				$query = $this->mysqli->query("INSERT INTO users (`date`, `ip`, `username`, `password`, `supportpin`, `ref`) VALUES (\"" . date("n/j/Y g:i a") . "\", \"". $_SERVER['REMOTE_ADDR'] . "\", \"" . $username ."\", \"" . $password . "\", \"". rand(10000,99999) . "\",'0');");				
		...
		{  
			$msg = '
			 <!-- sample modal content -->
                            <div id="att" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
Secret Key: <strong>'.$secret.'</strong><br /> <div class="alert alert-danger">Please write this down and keep in a secure area.</div><br><img src="'.$qrcode.'"><br />Please scan this with the Google Authenticator app on your mobile phone. This page will clear on refresh, please be careful.
                            ...
                            <div id="att" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-center">
Two Factor Auth has been disabled for your account and will no longer be required when you sign in.
                                        </div>
                                        <div class="modal-footer  bg bg-warning">
                                            <button type="button" class="btn btn-danger waves-effect col-sm-12 text-center" data-dismiss="modal">Close</button>
                                        </div>
